...
function getAnalystSummary(rows: ResultRow[]) {
...
export function ResultTable({ rows }: { rows: ResultRow[] }) {
  if (rows.length === 0) {
    return (
      <Card className="p-6 text-sm italic text-muted-foreground dark:border-slate-800 dark:bg-slate-900/80">
  ...
  return (
    <Card className="overflow-hidden p-0 dark:border-slate-800 dark:bg-slate-900/80">
        ...
        <Table className="min-w-[1500px]">
          <TableHeader>
            <TableRow className="hover:bg-transparent">
              ...
              <TableHead className="min-w-[100px] text-center">
                Tegangan<br />Hancur<br />(Kg/cm²)
              </TableHead>
              <TableHead className="min-w-[140px] text-center">
                Konversi Teg.<br />Hancur ke Kubus<br />(Kg/cm²)
              </TableHead>
          ...
          <tfoot className="border-t border-slate-200 bg-slate-50 dark:border-slate-700 dark:bg-slate-800/30">
            <tr>
              ...
              <td colSpan={12} className="px-4 py-3 text-sm text-slate-700 dark:text-slate-200">
                {analystSummary}
              </td>
            </tr>
          </tfoot>
